...
local cfglocation = "GaywareCFG/"      
makefolder("GaywareCFG")      
...
local gui = library:New("Gayware.eu 0.1")      
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
	...
	if values.misc.chat["kill say"].Toggle then      
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "nn fue destruido por mexicanhook. propiedad de p100 cheat (mexicanhook)", false, "Innocent", false, true)      
	end      
end)      
...
ChatScript.createNewMessage("GAYWARE.EU","GAYWARE.EU has successfully loaded.",MainUIColor,Color3.new(1,1,1),0.01,nil)
ChatScript.moveOldMessages()
ChatScript.createNewMessage("GAYWARE.EU","Version 0.1",MainUIColor,Color3.new(1,1,1),0.01,nil)